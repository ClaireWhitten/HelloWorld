    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* //oefening 1
             ...
             switch (jaar)
             {
                 case "1302": Console.WriteLine($"In 1302 startte the battle of the golden spurs"); break;
            ...
            //instead of putting the console.ReadLine in the brackets can make ONE answer variable and reuse it - put  antwoord= Console.ReadLine() before each switch

            switch (Console.ReadLine())
            {
                case "1":
                    Console.WriteLine("Oei. Heb je al geprobeerd om het op te zoeken op het internet? \n 1. Ja, tevergeefs. \n 2. Oh, slim! Ik zal het even proberen");  // don't put the break here!! Program breaks off!! put at end of the nested switch
                    switch (Console.ReadLine())
                    {
                        case "1":
                            Console.WriteLine("Anders moet je het eens aan je medecursisten vragen? \n 1. Die weten het antwoord ook niet..  \n 2. Ah ja, misschien weten zij het!");
                            switch (Console.ReadLine())
                            {
                            ...
                            break; //break for first case should go here!!
                        case "2": Console.WriteLine("Graag gedaan!"); break;
                    }
                    break; //break for first case should go here!!

                case "2":
                    Console.WriteLine("Oei, wil je iets doen? \n 1.Vertel me eens een mopje! \n 2.Ik zou graag de oefening afwerken. \n 3.Niet per see, tot later");  // don't put the break here!! Program breaks off!! put at end of the nested switch
                    switch (Console.ReadLine())
                    {
